...
| enabled | If true, alb will be created. | string | `false` | no |
...
| target_groups_defaults | Default values for target groups as defined by the list of maps. | string | `<map>` | no |
